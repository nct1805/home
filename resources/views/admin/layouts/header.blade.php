      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="admin/products/list"><i class="fa fa-circle-o"></i> Danh sách sản phẩm</a></li>
            <li><a href="admin/category/list"><i class="fa fa-circle-o"></i> Danh mục sản phẩm</a></li>
          </ul>
        </li> 
        <li class="active treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="admin/news/list"><i class="fa fa-circle-o"></i> Danh sách tin tức</a></li>
          </ul>
        </li>
        <li class="">
